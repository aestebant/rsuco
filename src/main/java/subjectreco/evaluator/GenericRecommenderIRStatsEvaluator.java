...
public final class GenericRecommenderIRStatsEvaluator implements RecommenderIRStatsEvaluator {
	...
	public GenericRecommenderIRStatsEvaluator(long seed) {
		this(new GenericRelevantItemsDataSplitter(), seed);
	}

	public GenericRecommenderIRStatsEvaluator(RelevantItemsDataSplitter dataSplitter, long seed) {
